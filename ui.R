  ...
  fluidRow(
    ...
    column(3, offset = 4,
           wellPanel(
             ...
             bsTooltip("register_password", "Password should be 8 or more alphanumeric characters", "left"),
             div(class = "input_msg", textOutput("register_password_msg")),
             passwordInput("register_password_re", "Re-enter password"),
             bsTooltip("register_password_re", "Password should be 8 or more alphanumeric characters", "left"),
